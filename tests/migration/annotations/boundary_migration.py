...
def migrate_boundary_annotation_data_one_to_one_mapping_int_to_float() -> (
    ...
    parameterv1 = Parameter(
        ...
        assigned_by=ParameterAssignment.POSITION_OR_NAME,
        is_public=True,
        documentation=ParameterDocstring("int", "1", "int in the range of (0, 10)"),
    )
    parameterv2 = Parameter(
        ...
        assigned_by=ParameterAssignment.POSITION_OR_NAME,
        is_public=True,
        documentation=ParameterDocstring("float", "1.0", "float in the range of [1.0, 9.0]"),
    )
...
def migrate_boundary_annotation_data_one_to_one_mapping_float_to_int() -> (
    ...
    parameterv1 = Parameter(
        ...
        assigned_by=ParameterAssignment.POSITION_OR_NAME,
        is_public=True,
        documentation=ParameterDocstring("float", "1.0", "float in the range of [0.5, 9.5]"),
    )
    parameterv2 = Parameter(
...
def migrate_boundary_annotation_data_one_to_many_mapping() -> (
    ...
    parameterv2_b = Parameter(
        ...
        assigned_by=ParameterAssignment.POSITION_OR_NAME,
        is_public=True,
        documentation=ParameterDocstring("float", "1.0", "float in the range of (0.0, 10.0)"),
    )
